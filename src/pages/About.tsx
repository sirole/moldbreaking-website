...
const About = () => {
  const companyInfo = [
    { label: '会社名', value: '株式会社MoldBreaking' },
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-3">
                  <span className="text-brand-yellow text-xs font-medium shrink-0 sm:w-16">Concept</span>
                  <p className="text-zinc-300 text-sm">健康で美しい</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-3">
                  <span className="text-brand-yellow text-xs font-medium shrink-0 sm:w-16">Core Value</span>
                  <p className="text-zinc-300 text-sm break-words">ライブを通してWOWを届けよ</p>
                </div>
              </div>
